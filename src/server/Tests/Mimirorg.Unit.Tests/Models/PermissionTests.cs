...
namespace Mimirorg.Test.Unit.Models
{
    public class PermissionTests : UnitTest<MimirorgCommonFixture>
    {
        ...
        [InlineData(MimirorgPermission.Manage, MimirorgPermission.Delete, true)]
        ...
        [InlineData(MimirorgPermission.Approve, MimirorgPermission.Delete, true)]
        ...
        [InlineData(MimirorgPermission.Delete, MimirorgPermission.Manage, false)]
        [InlineData(MimirorgPermission.Delete, MimirorgPermission.Approve, false)]
        [InlineData(MimirorgPermission.Delete, MimirorgPermission.Delete, true)]
        [InlineData(MimirorgPermission.Delete, MimirorgPermission.Write, true)]
        [InlineData(MimirorgPermission.Delete, MimirorgPermission.Read, true)]
        ...
        [InlineData(MimirorgPermission.Write, MimirorgPermission.Delete, false)]
