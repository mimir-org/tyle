...
{
    public class AttributeQualifierConfiguration : IEntityTypeConfiguration<AttributeQualifierLibDm>
    {
        public void Configure(EntityTypeBuilder<AttributeQualifierLibDm> builder)
        {
