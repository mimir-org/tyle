...
public class AttributeConfiguration : IEntityTypeConfiguration<AttributeLibDm>
{
    public void Configure(EntityTypeBuilder<AttributeLibDm> builder)
    {
        ...
        builder.Property(p => p.ContributedBy).HasColumnName("ContributedBy").IsRequired().HasConversion(stringConverter, stringComparer);
        ...
        builder.Property(p => p.UoMs).HasColumnName("UoMs").IsRequired().HasConversion(stringConverter, stringComparer);
