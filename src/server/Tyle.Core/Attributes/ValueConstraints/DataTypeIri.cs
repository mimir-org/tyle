...
public class DataTypeIri : HasCardinality, IValueConstraint
{
    /// <summary>
    /// Creates a new IRI data type constraint.
    /// </summary>
    ...
    public DataTypeIri(int minCount, int? maxCount = null) : base(minCount, maxCount)
    {
    }
}