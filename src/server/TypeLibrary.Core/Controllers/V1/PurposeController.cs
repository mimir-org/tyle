...
public class PurposeController : ControllerBase
{
    ...
    [HttpGet]
    [ProducesResponseType(typeof(ICollection<PurposeReferenceCm>), StatusCodes.Status200OK)]
    ...
    [HttpGet("{id}")]
    [ProducesResponseType(typeof(PurposeReferenceCm), StatusCodes.Status200OK)]
