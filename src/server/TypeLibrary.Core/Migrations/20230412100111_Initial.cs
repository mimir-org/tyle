    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(31)", maxLength: 31, nullable: false),
                    ...
                    FirstVersionId = table.Column<string>(type: "nvarchar(31)", maxLength: 31, nullable: false),
                    ...
                    ParentId = table.Column<string>(type: "nvarchar(31)", maxLength: 31, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(31)", maxLength: 31, nullable: false),
                    ObjectId = table.Column<string>(type: "nvarchar(31)", maxLength: 31, nullable: false),
                    ...
                    ObjectFirstVersionId = table.Column<string>(type: "nvarchar(31)", maxLength: 31, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AspectObjectsId = table.Column<string>(type: "nvarchar(31)", nullable: false),
                    AttributesId = table.Column<string>(type: "nvarchar(31)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AspectObjectId = table.Column<string>(type: "nvarchar(31)", nullable: true),
                    TerminalId = table.Column<string>(type: "nvarchar(31)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    AttributesId = table.Column<string>(type: "nvarchar(31)", nullable: false),
                    TerminalsId = table.Column<string>(type: "nvarchar(31)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttributeId = table.Column<string>(type: "nvarchar(31)", nullable: true),
                    UnitId = table.Column<string>(type: "nvarchar(31)", nullable: true)
                },
                constraints: table =>
                {
