...
namespace TypeLibrary.Core.Profiles
{
    ...
    {
        public AttributeQualifierProfile(IApplicationSettingsRepository settings, IHttpContextAccessor contextAccessor)
        {
            CreateMap<AttributeQualifierLibAm, AttributeQualifierLibDm>()
                .ForMember(dest => dest.Id, opt => opt.UseDestinationValue())
                .ForMember(dest => dest.Name, opt => opt.MapFrom(src => src.Name))
                .ForMember(dest => dest.Description, opt => opt.MapFrom(src => src.Description))
                .ForMember(dest => dest.Iri, opt => opt.MapFrom(src => $"{settings.ApplicationSemanticUrl}/attribute/qualifier/{HttpUtility.UrlEncode(src.Name)}"))
            ...
            CreateMap<AttributeQualifierLibDm, AttributeQualifierLibCm>()
