    ...
    public class NodeProfile : Profile
    {
        public NodeProfile(IApplicationSettingsRepository settings, IHttpContextAccessor contextAccessor)
        {
            CreateMap<NodeLibAm, NodeLibDm>()
                ...
                .ForMember(dest => dest.Parent, opt => opt.MapFrom(src => string.IsNullOrWhiteSpace(src.ParentId) ? null : src.ParentId))
                ...
                .ForMember(dest => dest.AttributeAspectIri, opt => opt.MapFrom(src => string.IsNullOrWhiteSpace(src.AttributeAspectIri) ? null : src.AttributeAspectIri))
