...
namespace TypeLibrary.Core.Profiles
{
    ...
    {
        public InterfaceProfile(IApplicationSettingsRepository settings, IHttpContextAccessor contextAccessor, ICompanyFactory companyFactory)
        {
            ...
            CreateMap<InterfaceLibCm, ApprovalCm>()
                .ForMember(dest => dest.Id, opt => opt.MapFrom(src => src.Id))
                .ForMember(dest => dest.Name, opt => opt.MapFrom(src => src.Name))
                .ForMember(dest => dest.Description, opt => opt.MapFrom(src => src.Description))
                .ForMember(dest => dest.ObjectType, opt => opt.MapFrom(src => "Interface"))
                .ForMember(dest => dest.State, opt => opt.MapFrom(src => src.State))
