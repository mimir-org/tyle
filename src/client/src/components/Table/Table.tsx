...
import { sizingMixin, typographyMixin } from "styleConstants";
import styled, { css } from "styled-components";
import { Sizing, Typography } from "types/styleProps";
...
export const Table = styled.table<TableProps>`
  ...
  ${({ borders, ...props }) =>
    ...
    css`
      ...
      ${Tr}:not(:last-of-type) {
        border-bottom: 1px solid ${props.theme.tyle.color.outline.base};
      }
