import { FormField, Select, Textarea } from "@mimirorg/component-library";
...
import {
  AspectSelectWrapper,
  BlockBaseFormWrapper,
  DescriptionInputWrapper,
  NameInputWrapper,
  NotationInputWrapper,
  PurposeSelectWrapper,
} from "./BlockBaseForm.styled";
import { BlockFormStepProps } from "./BlockForm";

const BlockBaseForm = React.forwardRef<HTMLFormElement, BlockFormStepProps>(({ fields, setFields }, ref) => {
  ...
  return (
    <BlockBaseFormWrapper onSubmit={handleSubmit} ref={ref}>
      <NameInputWrapper>
...
BlockBaseForm.displayName = "BlockBaseForm";

export default BlockBaseForm;
