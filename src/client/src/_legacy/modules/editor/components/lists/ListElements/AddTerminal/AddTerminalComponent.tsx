import { TerminalTypeItem, ConnectorDirection, TerminalType } from "../../../../../../models";
...
const AddTerminalComponent = ({ terminals, defaultTerminal, onChange }: Props) => (
  <TerminalElementWrapper>
    ...
    <DirectionalDropdown
      ...
      value={defaultTerminal ? Number(defaultTerminal.connectorType) : Number(ConnectorDirection.Input)}
    />
