...
import { filterCompanyList, hasAccess } from "./access.helpers";

const createEmptyMimirorgCompanyCm = (): MimirorgCompanyCm => ({
  id: 0,
  name: "",
  displayName: "",
  description: "",
...
const createEmptyMimirorgUserCm = (): MimirorgUserCm => ({
  id: "",
  email: "",
  firstName: "",
  lastName: "",
