...
export const aspectObjectSchema = (t: TFunction<"translation">) =>
  yup.object<YupShape<FormAspectObjectLib>>({
    ...
    companyId: yup
      .number()
      .min(1, t("aspectObject.validation.companyId.min"))
      .required(t("aspectObject.validation.companyId.required")),
    ...
    aspectObjectTerminals: yup
      ...
      .of(
        yup.object().shape({
          ...
          maxQuantity: yup
            .number()
            .min(0, t("aspectObject.validation.aspectObjectTerminals.maxQuantity.min"))
            .required(),
          minQuantity: yup
            .number()
