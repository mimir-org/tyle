...
import { InfoItemButtonProps } from "../../../../content/common/info-item/InfoItemButton";
import { Default as SelectItemInfoButton } from "../../../../content/common/info-item/InfoItemButton.stories";
