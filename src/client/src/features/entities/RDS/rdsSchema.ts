...
export const rdsSchema = (t: TFunction<"translation">, usedRdsCode: string[]) =>
  yup.object<YupShape<RdsLibAm>>({
    rdsCode: yup.string().max(10, t("rds.validation.rdsCode.max")).required(t("rds.validation.rdsCode.required")).notOneOf(usedRdsCode, t("rds.validation.rdsCode.unique")),
