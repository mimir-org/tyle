...
import { FormAttributeGroupLib, toFormUnitHelper } from "./types/formAttributeGroupLib";
...
export const AttributeGroupFormBaseFields = ({ limited }: AttributeGroupFormBaseFieldsProps) => {
  ...
  const {
    ...
    setValue,
    formState: { errors },
  } = useFormContext<FormAttributeGroupLib>();
  ...
  return (
    <FormBaseFieldsContainer>
      ...
      <FormField label={t("unit.multiple")}>
        <Controller
          name="units"
          control={control}
